                    ...
                    <div className="grid md:grid-cols-2">
                        <div className="h-full pr-6">
                            <p className="mt-3 mb-12 text-lg text-gray-600 dark:text-slate-400">
                                Chúng tôi luôn sẵn sàng hỗ trợ và đáp ứng nhu cầu của bạn. Hãy liên hệ với chúng tôi qua
                                thông tin dưới đây để nhận được sự tư vấn và dịch vụ tốt nhất.
                            </p>
                        ...
                        <div className="card h-fit max-w-6xl p-5 md:p-12" id="form">
                            <form id="contactForm">
                                ...
                                <div className="text-center">
                                    <button type="submit"
                                            className="w-full bg-black dark:bg-white dark:text-black text-white px-6 py-3 font-xl rounded-md sm:mb-0">Send
                                        Message
                                    </button>
                                </div>
                            </form>
