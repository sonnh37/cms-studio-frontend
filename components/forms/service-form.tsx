...
export const ServiceForm: React.FC<ServiceFormProps> = ({ initialData }) => {
    ...
    const form = useForm<z.infer<typeof formSchema>>({
        ...
        defaultValues: { title: "", description: "", src: "", type: "", createdBy: "N/A", createdDate: new Date(), isDeleted: false },
    });
    ...
    const onSubmit = async (values: z.infer<typeof formSchema>) => {
        ...
        try {
            setLoading(true);
            if (initialData) {
                await axios.put('https://localhost:7192/service-management/services', values);
                Swal.fire({
                    title: 'Success!',
                ...
                await axios.post('https://localhost:7192/service-management/services', values);
                Swal.fire({
                    title: 'Success!',
